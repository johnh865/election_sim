...
from votesim.votesystems import (condorcet, irv, plurality, score,)
...
method_keywords['rrv'] = method_keywords['cardinal', 'proportional rep']
method_keywords['seq_monroe'] = method_keywords['cardinal', 'proportional rep']
...
method_keywords['smith_minimax'] = method_keywords['ranked', 'condorcet']
method_keywords['ranked_pairs'] = method_keywords['ranked', 'condorcet']
method_keywords['irv'] = method_keywords['ranked', ]
method_keywords['irv_stv'] = method_keywords['ranked', 'proportional rep']
method_keywords['top_two'] = method_keywords['ranked', ]
